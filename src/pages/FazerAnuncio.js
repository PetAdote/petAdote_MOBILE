...
export class PublicarAnuncio extends React.Component {
                ...
                <View style={styles.container}>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.containerForm}>
                            ...
                            <TouchableOpacity style={styles.btnProximo} onPress={() => {this.props.navigation.navigate('selecioneOAnimal');}}>

                                <Text style={styles.textCadastroBlack}>Selecionar</Text>
